        ...
        <Stack spacing={2} sx={{mb:3}}>
            <Stack direction="column" divider={<Divider />} spacing={2} sx={{my: 2}}>
                <div>
                    ...
                    <Typography gutterBottom sx={{color: "text.secondary"}}>
                        {getValues("address")} / {getValues("city")} </Typography>
                </div>
                <div>
                    <Typography variant="subtitle2" gutterBottom 
                        sx={{display: "flex", alignItems: "center", mb: 2}}>
                        <PaymentsIcon color="primary" sx={{mr:2}}/> Ödeme Bilgileri</Typography>
                    ...
                    <Typography gutterBottom sx={{color: "text.secondary"}}>{getValues("cardexpiremonth")}/{getValues("cardexpireyear")} </Typography>
                </div>
            </Stack>
        </Stack>
    );
